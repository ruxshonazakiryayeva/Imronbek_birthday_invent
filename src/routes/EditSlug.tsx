...
export default function EditSlug() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-md space-y-4 bg-background px-4 py-8">
      <h1 className="font-display text-xl text-foreground">Taklifnomani tahrirlash</h1>
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Bolaning ismi</label>
        <input
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Necha yoshga to'ladi</label>
        <input
          type="number"
          className="field mt-1"
          value={form.age}
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Sana va vaqt</label>
        <input
          type="datetime-local"
          className="field mt-1"
          value={dateForInput}
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Manzil (matn)</label>
        <input
          className="field mt-1"
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Xarita havolasi</label>
        <input
          className="field mt-1"
          value={form.map_url ?? ""}
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Musiqa</label>
        ...
        <div className="mt-3">
          <label className="text-xs text-muted-foreground">Yoki YouTube havolasini joylashtiring</label>
          <input
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Bayram dasturi (soatlari)</label>
        <p className="mb-2 text-xs text-muted-foreground">
      ...
      <div>
        <label className="block text-sm font-semibold text-foreground">Galereya rasmlari</label>
        <input
          type="file"
          accept="image/*"
          multiple
      ...
      <button className="btn-magic w-full" onClick={save} disabled={saving}>
